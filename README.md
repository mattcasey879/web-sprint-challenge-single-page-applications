...
1. How would you explain form validation to someone who has never programmed before?
  Validation is making sure your on code is doing what it is supposed to be doing and not having any bugs

1. In 1-2 sentences, define end to end testing.
 end to end or e2e is testing everything about your application from top to bottom.
